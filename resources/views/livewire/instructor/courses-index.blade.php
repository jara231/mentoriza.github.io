<div class="container py-8">
    ...
    <x-table-responsive>
        ...
        <div class="px-8 py-4 flex">
            <input wire:keydown="limpiar_page" wire:model.live="search" class="form-input flex-1 shadow-sm" placeholder="Ingrese el nombre de un curso...">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        ...
                                        @else
                                          <img class="h-10 w-10 rounded-full object-cover object-center" src="https://images.pexels.com/photos/287227/pexels-photo-287227.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="">
                                        @endisset
                                    </div>
                                    <div class="ml-4">
